...
def build_gate_diagnostics(
    ...
    summary_path.write_text(
        ...
        f"{listed_sources}\n\n"
        "## Related files packaged for Codex\n\n"
        f"{listed_related}\n\n"
        "## Full evidence\n\n"
        "Codex must inspect `gate-full.log`; the local worker receives only this summary and a bounded tail.\n",
        encoding="utf-8",
    )
    ...
    bundle_path = diagnostics_dir / "codex-error-bundle.zip"
