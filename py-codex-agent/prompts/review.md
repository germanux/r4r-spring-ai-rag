...
diff/evidence files, current task-gate logs and the local model's understanding
report. Do not edit files, run Git writes, select another task or accept on the
basis of prose alone.
